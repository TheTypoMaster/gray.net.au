...
BLOG_AUTHOR = "James Gray"  # (translatable)
...
# DEPLOY_COMMANDS = []
DEPLOY_COMMANDS = {
    u'default': [u'rsync -racv --exclude-from=destination-excluded.txt --delete --chmod=Du=rwx,Dg=rx,Do=rx,Fu=rw,Fg=r,Fo=r -p output/ bluehost:/home/grayneta/public_html']
}
...
# is in the manual.
COMMENT_SYSTEM_ID = "thegraymatter"
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-551e496c5cc02eb0" async="async"></script>
